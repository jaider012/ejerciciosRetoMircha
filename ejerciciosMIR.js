...
function recortados(string, numero) {
  if (string == Object || string == Array) {
    return "not string";
  } else {
    let devuelto = "";
...
function DestringaArray(string, separador) {
  newArray = string.split(separador);
  return newArray;
}

/* 4) Programa una función que repita un texto X veces, pe. miFuncion('Hola Mundo', 3) devolverá Hola Mundo Hola Mundo Hola Mundo */
function repitaX(string,numero){
  let newstring = ""
...
*/
module.exports = { nuemerodecaracteres, recortados, DestringaArray, repitaX};
